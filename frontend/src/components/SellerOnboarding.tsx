            ...
            <AnimatePresence mode="wait">
              ...
              <motion.div
                ...
                <div
                  ...
                  onDrop={(e) => {
                    e.preventDefault();
                    setIsDragOver(false);
                    setUploadedFile('national_id.jpg');
                  }}
                  ...
                  <div className="flex flex-col items-center gap-3">
                          ...
                          <p className="font-semibold text-gray-700 dark:text-gray-300 font-body">
                            Drag & drop your National ID
                          </p>
                          <p className="text-xs text-gray-400 dark:text-gray-500 font-body">
                            JPG, PNG or PDF · Max 5MB · Both sides required
                          </p>
                          <button className="mt-2 px-5 py-2 bg-forest text-white text-sm font-semibold rounded-lg hover:bg-forest-light transition-colors">
                            Browse Files
                          </button>
                        </div>
                  }
                ...
                <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 font-body mb-2">
                          KRA PIN Number
                        </label>
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500 font-body mt-1.5">
                          Your KRA PIN is used only for identity verification
                          and is never stored
                        </p>
                      </div>
                      <div className="flex items-start gap-3 p-4 bg-gold/5 dark:bg-gold/10 rounded-xl border border-gold/20">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400 font-body">
                          Required by the Kenya Revenue Authority for all
                          property transactions. Your data is encrypted and
                ...
                <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-400 dark:text-gray-500 font-body mt-1.5">
                          Found on your title deed. We'll verify this against
                          the Ardhisasa database.
                        </p>
                      </div>
                      <div className="flex items-center gap-3 p-4 bg-forest/5 dark:bg-forest/10 rounded-xl border border-forest/10 dark:border-forest/20">
                        ...
                        <p className="text-xs text-gray-600 dark:text-gray-400 font-body">
                          Ardhisasa check confirms: ownership, encumbrances,
                          caveats, and rates clearance. Takes ~30 seconds.
                        </p>
                      </div>
                    </div>
                }
              ...
              <motion.div
                ...
                className="text-center py-8">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 font-body text-sm max-w-sm mx-auto mb-6">
                    Your verification is under review. We'll notify you within
                    24 hours once your listing is approved and goes live.
                  </p>
                  <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gold/10 dark:bg-gold/20 rounded-full border border-gold/30">
                    ...
                    <span className="text-sm font-semibold text-gold-dark dark:text-gold">
